...
public class Life_Style_video extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_life__style_video);
    ...
    public void setRecyclerView() {
        ...
        recyclerView = findViewById(R.id.lifeStyleRecyclerViewId);
